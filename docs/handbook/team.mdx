...
Meet the teams that make Intellisper magical ✨
...
<CardGroup cols={2}>
  ...
  <Card title="Platform" icon="server">
    Building the engine room that keeps Intellisper running smoothly, securely, and at scale.
  </Card>

  <Card title="Blocks" icon="puzzle-block">
...
| Kishan Parmar               | Blocks                             | [LinkedIn](https://www.linkedin.com/in/kishanprmr/)                                  |
| Sanket Nannaware            | Blocks                             | [LinkedIn](https://www.linkedin.com/in/sanket-nannaware-a8505a22a/)                  |
| David Anyatonwu             | Blocks                             | [LinkedIn](https://www.linkedin.com/in/david-anyatonwu-79165988/)                    |
