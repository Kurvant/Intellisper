...
<Steps>
  ...
  <Step title="Step 2: Generate a JWT">
    ...
    | role              | Role of the user in the Intellisper project (e.g., **EDITOR**, **VIEWER**, **ADMIN**)           |
    | exp               | Expiry timestamp for the token (Unix timestamp)  |
    | piecesFilterType  | Customize the project blocks, check [customize blocks](/embedding/customize-blocks)  |
    | piecesTags        | Customize the project blocks, check [customize blocks](/embedding/customize-blocks)  |
