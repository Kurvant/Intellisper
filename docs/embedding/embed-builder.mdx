...
| --- | --- | --- | --- |
| instanceUrl| ✅ |  string | The url of the instance hosting Intellisper, could be https://cloud.activepieces.com if you are a cloud user. |
...
| embedding.hideTables | ❌ | boolean | Hides the Tables UI in the dashboard (tree, filters, create/import buttons) and blocks direct access to the table editor route. The Tables block used inside flows is unaffected. By default it is false. (added in [0.9.0](./sdk-changelog#04%2F21%2F2026-0-9-0)) |
