...
| `blockName` | string | No | For PIECE types: block name (short names like `slack` accepted) |
...
- **PIECE**: `blockName`, `actionName`, `input`, `auth`, `continueOnFailure`, `retryOnFailure`
...
| `blockName` | string | No | For PIECE steps |
