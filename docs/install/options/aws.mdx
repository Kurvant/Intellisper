...
For a full list of all the currently available configuration options, take a look at the [Intellisper Pulumi template file on GitHub](https://github.com/activepieces/activepieces/tree/main/deploy/pulumi/Pulumi.yaml).
