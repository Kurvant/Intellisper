...
Intellisper uses Zod for runtime validation of block properties. Zod provides a powerful schema validation system that helps ensure your block receives valid inputs.

To use Zod validation in your block, first import the validation helper and Zod:
