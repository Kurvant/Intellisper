---
title: "1Password"
description: "Connect 1Password to Intellisper for centralized secret management"
---
...
3. Give it a name (e.g. `Intellisper`).
4. Grant it **Read Items** access on the vaults Intellisper needs to access.
...
Intellisper will retrieve the secret value from 1Password and inject it into the connection at runtime.
