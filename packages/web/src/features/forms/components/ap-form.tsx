...
/**We do this because it was the behaviour in previous versions of Intellisper.*/
...
const IbForm = ({ form, useDraft }: IbFormProps) => {
              ...
              <CardContent>
                ...
                {markdownResponse && (
                  <>
                    ...
                    <IbMarkdown markdown={markdownResponse} />
                  </>
                )}
              </CardContent>
            </Card>
