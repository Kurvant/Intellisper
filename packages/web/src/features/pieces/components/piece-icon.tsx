...
const blockIconVariantsWithPadding = cva('', {
  variants: {
    size: {
      xxl: 'p-4',
      xl: 'p-3',
...
interface BlockIconProps extends VariantProps<typeof blockIconVariants> {
  displayName?: string;
  logoUrl?: string;
  showTooltip: boolean;
  background?: string;
          ...
          >
            {logoUrl ? (
              <ImageWithColorBackground
                ...
                alt={displayName}
                className={cn(
                  blockIconVariantsWithPadding({ size }),
