import { Field, Table, PopulatedRecord, isNil } from '@intelblocks/shared';
...
const TableContext = createContext<IbTableStore | null>(null);
...
export const TableStateProviderWithTable = ({
  ...
  const tableStoreRef = useRef<IbTableStore>(
...
export function IbTableStateProvider({
  children,
}: {
  children: React.ReactNode;
}) {
