...
const IbFieldActionMenuItemRenderer = ({
  action,
}: {
...
IbFieldActionMenuItemRenderer.displayName = 'IbFieldActionMenuItemRenderer';
export default IbFieldActionMenuItemRenderer;
