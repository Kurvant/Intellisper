import { Template } from '@intelblocks/shared';
import { t } from 'i18next';
import React from 'react';

import { TagWithBright } from '@/components/custom/tag-with-bright';
import { Card, CardContent } from '@/components/ui/card';
import { BlockIconList } from '@/features/pieces';
import { useGradientFromBlocks } from '@/features/templates';
...
export const ExploreTemplateCard = React.memo(
  ({ template, onTemplateSelect }: TemplateCardProps) => {
    ...
    const { gradient } = useGradientFromBlocks(
