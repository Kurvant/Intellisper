import { ApiKeyResponseWithoutValue } from '@intelblocks/shared';
...
const ApiKeysPage = () => {
  ...
  return (
    <LockedFeatureGuard
      ...
      lockDescription={t(
        'Create and manage API keys to access Intellisper APIs.',
      )}
      lockVideoUrl="https://cdn.activepieces.com/videos/showcase/api-keys.mp4"
    >
      <CenteredPage
        title={t('API Keys')}
        description={t('Manage API keys to access Intellisper APIs.')}
        actions={
