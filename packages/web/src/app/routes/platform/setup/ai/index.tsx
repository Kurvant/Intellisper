...
export default function AIProvidersPage() {
  ...
  return (
    <LockedFeatureGuard
      ...
      lockDescription={t(
        'Set your AI providers so your users enjoy a seamless building experience with our universal AI blocks',
      )}
    >
      <CenteredPage
        ...
        description={
          allowWrite
            ...
            : t(
                'Available AI providers that will be used by universal AI blocks, i.e Text AI.',
              )
        }
...
function ChatProviderSelector({
  ...
  const getLogoUrl = (providerName: string) =>
    ...
    (providerName === AIProviderName.INTELLISPER
      ? INTELLISPER_LOGO_URL
      : undefined);
