import { ApplicationEventName } from '@intelblocks/shared';
...
export const useEventLabels = (): EventLabelsMap => {
  return {
    ...
    [ApplicationEventName.SECRET_MANAGER_CONNECTED]: {
      label: t('Secret manager connected'),
    },
    [ApplicationEventName.SECRET_MANAGER_ROTATED]: {
      label: t('Secret manager rotated'),
    },
    [ApplicationEventName.SECRET_MANAGER_DISCONNECTED]: {
      label: t('Secret manager disconnected'),
    },
  };
};
