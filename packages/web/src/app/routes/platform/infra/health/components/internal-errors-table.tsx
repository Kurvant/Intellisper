import { InternalErrorImpactItem } from '@intelblocks/shared';
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          {t(
            'Internal errors are failures inside Intellisper itself (engine or worker), not in your flow logic. Grouped by the project and flow they affected.',
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
