      ...
      message: (
        <span>
          {systemHealth?.disk
            ...
            : t(
                'Insufficient disk space. A minimum of 30GB is required for Intellisper to function properly.',
              )}
        </span>
      ),
      loading: isPending,
    ...
    },
    {
      ...
      message: (
        <span>
          {systemHealth?.cpu
            ? t(
                'The server has enough CPU resources. At least 1 CPU core is required to run Intellisper.',
              )
            : t(
                'Not enough CPU resources. At least 1 CPU core is necessary to operate Intellisper.',
              )}
        </span>
      ),
      link: 'https://www.activepieces.com/docs/install/configuration/hardware#technical-specifications',
