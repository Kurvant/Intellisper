import { isNil, USE_DRAFT_QUERY_PARAM_NAME } from '@intelblocks/shared';
import { useParams } from 'react-router-dom';
import { useSearchParam } from 'react-use';

import { LoadingScreen } from '@/components/custom/loading-screen';
import { IbForm, formsQueries } from '@/features/forms';
...
export const FormPage = () => {
  ...
  return (
    <>
      ...
      {form && !isLoading && <IbForm form={form} useDraft={useDraft} />}
    </>
  );
};
