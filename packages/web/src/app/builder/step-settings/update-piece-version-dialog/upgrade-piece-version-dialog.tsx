import { BlockAction, BlockTrigger } from '@intelblocks/shared';
...
export const UpgradeBlockVersionContent: React.FC<
  UpgradeBlockVersionContentProps
> = ({
  step,
  currentVersion,
  latestVersion,
...
export type UpgradeBlockVersionContentProps = {
