...
const isBlockTrigger = (
  step: Step,
): step is Extract<FlowTrigger, { type: FlowTriggerType.BLOCK }> =>
...
const useConfigureStepShortcutToast = (stepIsValid: boolean) => {
  useEffect(() => {
    ...
    const onKeyDown = (e: KeyboardEvent) => {
      // `key` is absent on keydown events the browser synthesises without a
      // physical key — IME composition, autofill, and focus changes across a popup.
      if (isNil(e.key)) return;
      const isCtrlG =
