...
import { FlowTrigger, McpPropertyType } from '@intelblocks/shared';
...
function McpToolTestingDialog({
  ...
  const blockProps = formProps.reduce((acc, field: McpFormField) => {
    const blockProperty = {
