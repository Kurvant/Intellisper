import { AP_FUNCTIONS, IbFunction } from '@intelblocks/shared';
...
export function FunctionSearchPopover({
  ...
  const [hoveredFn, setHoveredFn] = useState<IbFunction | null>(null);
  ...
  const grouped = filtered.reduce<Record<string, IbFunction[]>>((acc, fn) => {
