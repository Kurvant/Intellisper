...
import { isNil, PropertySettings } from '@intelblocks/shared';
...
import { DynamicDropdownBlockProperty } from './dynamic-dropdown-piece-property';
        ...
        >
          {isNil(dynamicPropsInfo) ? (
            ...
            <DynamicDropdownBlockProperty
              ...
              blockName={dynamicPropsInfo.blockName}
              blockVersion={dynamicPropsInfo.blockVersion}
              form={form}
  ...
  dynamicPropsInfo:
    | ({
        ...
        | {
            ...
            updateFormSchema: (
              key: string,
              newFieldSchema: BlockPropertyMap,
            ) => void;
            updatePropertySettingsSchema: (
