import { DropdownState, PropertyType } from '@intelblocks/blocks-framework';
import { AUTHENTICATION_PROPERTY_NAME, isNil } from '@intelblocks/shared';
...
const DynamicDropdownBlockPropertyImplementation = React.memo(
  (props: DynamicDropdownProps) => {
    ...
    const { mutate, isPending, error } = blocksHooks.useBlockOptions<
  ...
  (props: DynamicDropdownProps) => {
    return (
      <DynamicPropertiesErrorBoundary>
        <DynamicDropdownBlockPropertyImplementation {...props} />
      </DynamicPropertiesErrorBoundary>
    );
  },
);
DynamicDropdownBlockProperty.displayName = 'DynamicDropdownPieceProperty';
DynamicDropdownBlockPropertyImplementation.displayName =
