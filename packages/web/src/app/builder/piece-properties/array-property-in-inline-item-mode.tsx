import { ArraySubProps } from '@intelblocks/blocks-framework';
...
type ArrayBlockPropertyInInlineItemModeProps = BaseArrayPropertyProps &
  (
...
const ArrayBlockPropertyInInlineItemMode = React.memo(
  (props: ArrayBlockPropertyInInlineItemModeProps) => {
...
ArrayBlockPropertyInInlineItemMode.displayName =
  'ArrayPiecePropertyInInlineItemMode';
export { ArrayBlockPropertyInInlineItemMode };
