...
import { ArrayBlockPropertyInInlineItemMode } from './array-property-in-inline-item-mode';
...
function AutoFormFieldWrapper({
  ...
  const isArrayProperty =
    !isBlockAuthProperty(property) && property.type === PropertyType.ARRAY;
    ...
    >
      <FormItem className="flex flex-col">
        ...
        {isArrayProperty && dynamicInputModeToggled && (
          <ArrayBlockPropertyInInlineItemMode
            disabled={disabled}
...
function getValueForInputOnDynamicToggleChange(
  property: BlockProperty | BlockAuthProperty[],
  newMode: PropertyExecutionType,
  currentValue: unknown,
) {
  const isAuthProperty = isBlockAuthProperty(property);
  switch (newMode) {
...
function PropertyTypeTooltip({ property }: { property: BlockProperty }) {
  if (
...
type AutoFormFielWrapperErrorBoundaryProps = {
  ...
  property: BlockProperty | BlockAuthProperty[] | null;
  dynamicInputModeToggled?: boolean;
};
...
function isBlockAuthProperty(
  property: BlockProperty | BlockAuthProperty[],
): property is BlockAuthProperty[] {
