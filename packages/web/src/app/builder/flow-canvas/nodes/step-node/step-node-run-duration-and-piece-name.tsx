...
const StepNodeRunDurationAndBlockName = ({
  stepName,
  blockDisplayName,
}: {
  stepName: string;
  ...
  return (
    ...
    >
      <TextWithTooltip
        tooltipMessage={blockDisplayName}
        key={blockDisplayName + selectedStepOutput?.duration}
      >
        <div
...
StepNodeRunDurationAndBlockName.displayName = 'StepNodeRunDurationAndPieceName';
export { StepNodeRunDurationAndBlockName };
