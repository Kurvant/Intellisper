...
import { IbBigAddButtonNode } from '../utils/types';

const IbBigAddButtonCanvasNode = React.memo(
  ({ data, id }: Omit<IbBigAddButtonNode, 'position'>) => {
    ...
    const [
      ...
      state.openedBlockSelectorStepNameOrAddButtonId === id,
                ...
                >
                  <div
                    ...
                    className={cn('rounded-lg bg-background relative', {
                      'bg-primary/80':
                        isShowingDropIndicator || isBlockSelectorOpened,
                      'shadow-add-button':
                        isIsStepInsideDropzone || isBlockSelectorOpened,
                      'transition-all':
...
IbBigAddButtonCanvasNode.displayName = 'IbBigAddButtonCanvasNode';
export { IbBigAddButtonCanvasNode };
