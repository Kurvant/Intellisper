...
import { IbGraphEndNode } from '../utils/types';
import FlowEndWidget from '../widgets/flow-end-widget';

const IbGraphEndWidgetNode = ({ data }: Omit<IbGraphEndNode, 'position'>) => {
...
IbGraphEndWidgetNode.displayName = 'IbGraphEndWidgetNode';
export default IbGraphEndWidgetNode;
