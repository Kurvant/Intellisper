...
import { IbButtonData } from '../utils/types';

const IbAddButton = React.memo((props: IbButtonData) => {
  const [isStepInsideDropZone, setIsStepInsideDropzone] = useState(false);
  const [activeDraggingStep, readonly, isBlockSelectorOpen, canvasOrientation] =
    useBuilderStateContext((state) => [
      state.activeDraggingStep,
      state.readonly,
      state.openedBlockSelectorStepNameOrAddButtonId === props.edgeId,
          ...
          >
            <div
              ...
              className={cn('rounded-md cursor-pointer transition-all z-50', {
                'shadow-add-button': isBlockSelectorOpen,
              })}
            >
              <div
                style={{
                ...
                className={cn(
                  ...
                  {
                    'bg-primary border-primary': isBlockSelectorOpen,
                  },
                )}
...
IbAddButton.displayName = 'IbAddButton';
export { IbAddButton };
