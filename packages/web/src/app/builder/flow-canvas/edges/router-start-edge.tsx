import { StepLocationRelativeToParent } from '@intelblocks/shared';
import { BaseEdge, EdgeProps } from '@xyflow/react';

import { flowCanvasConsts } from '../utils/consts';
import { IbRouterStartEdge } from '../utils/types';

import { IbAddButton } from './add-button';
...
export const IbRouterStartCanvasEdge = ({
  sourceX,
  sourceY,
  targetX,
  targetY,
  ...
  target,
  id,
}: EdgeProps & Omit<IbRouterStartEdge, 'position'>) => {
