...
const TestFlowWidget = () => {
  ...
  const triggerHasSampleData =
    flowVersion.trigger.type === FlowTriggerType.BLOCK &&
    !isNil(flowVersion.trigger.settings.sampleData?.lastTestDate);

  const isChatTrigger = blockSelectorUtils.isChatTrigger(
    flowVersion.trigger.settings.blockName,
    flowVersion.trigger.settings.triggerName,
  );
  const isManualTrigger = blockSelectorUtils.isManualTrigger({
