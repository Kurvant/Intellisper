import { IbEdition, IbFlagId, TeamProjectsLimit } from '@intelblocks/shared';
...
import { IbSidebarItem } from '../ap-sidebar-item';
...
export function PlatformSidebar() {
  ...
  const setupItems = [
    ...
    },
    {
      ...
      label: t('Blocks'),
      icon: PuzzleIcon,
      locked: !platform.plan.manageBlocksEnabled,
    },
    {
  ...
  const groups: {
    ...
    },
    {
      ...
      items: [
        ...
        {
          to: '/platform/observability/chat-analytics',
