...
import {
  ...
  displayNameToKebabCase, findBlock,
...
import { DedupeStrategy, Polling, pollingHelper } from '@intelblocks/blocks-common';
...
const createTrigger = async (blockName: string, displayTriggerName: string, triggerDescription: string, triggerTechnique: string) => {
    ...
    const triggersFolder = join(blockFolder, 'src', 'lib', 'triggers')
