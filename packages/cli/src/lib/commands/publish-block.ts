...
import { publishBlockFromFolder, findBlock, assertBlockExists } from '../utils/block-utils';
    ...
    .action(async (command) => {
        const questions = [
            ...
            },
            {
                ...
                choices: ['Env Variable (IB_API_KEY)', 'Manually'],
                default: 'Env Variable (IB_API_KEY)'
            }
        ]
        ...
        const apiKey = answers.apiKeySource === 'Env Variable (IB_API_KEY)' ? process.env.IB_API_KEY : answers.apiKey;
