import { AppConnectionValueForAuthProperty, BlockAuth, Property } from '@intelblocks/blocks-framework';
import { z } from 'zod';
...
export const cmsAuth = BlockAuth.CustomAuth({
