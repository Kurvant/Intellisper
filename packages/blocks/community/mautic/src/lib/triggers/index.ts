import { HttpMethod, HttpRequest, httpClient } from '@intelblocks/blocks-common';
import { mauticAuth } from '../auth';
import { Property, TriggerStrategy, createTrigger } from "@intelblocks/blocks-framework";
