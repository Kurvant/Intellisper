import { AppConnectionValueForAuthProperty, createTrigger, BlockPropValueSchema, TriggerStrategy } from '@intelblocks/blocks-framework';
import { AuthenticationType, DedupeStrategy, httpClient, HttpMethod, Polling, pollingHelper } from '@intelblocks/blocks-common';
