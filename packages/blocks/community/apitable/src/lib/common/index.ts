import { DynamicPropsValue, BlockPropValueSchema, Property } from '@intelblocks/blocks-framework';
...
export function makeClient(auth: BlockPropValueSchema<typeof APITableAuth>) {
...
export async function createNewFields(
	auth: BlockPropValueSchema<typeof APITableAuth>,
	datasheet_id: string,
	...
	const client = makeClient(auth as BlockPropValueSchema<typeof APITableAuth>);
