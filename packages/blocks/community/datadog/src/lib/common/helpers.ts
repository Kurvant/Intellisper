...
export const getDatadogConfiguration = (
  auth: AppConnectionValueForAuthProperty<typeof datadogAuth>
) => {
...
export const constructDatadogBaseUrl = (
  auth: AppConnectionValueForAuthProperty<typeof datadogAuth>,
  subdomain = 'api',
  version = 'v2'
) => {
...
export const constructDatadogBaseHeaders = (
  auth: AppConnectionValueForAuthProperty<typeof datadogAuth>
) => {
  return {
