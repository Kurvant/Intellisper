...
import { BlockAuth, Property, createBlock } from '@intelblocks/blocks-framework';
import { BlockCategory, tryCatch } from '@intelblocks/shared';
...
export const mailgunAuth = BlockAuth.CustomAuth({
...
export const mailgun = createBlock({
  displayName: 'Mailgun',
  description:
