...
import { HttpError, HttpMethod } from '@intelblocks/blocks-common';
import { z } from 'zod';
import { propsValidation } from '@intelblocks/blocks-common';
import { AppConnectionType } from '@intelblocks/shared';

export const jiraDataCenterAuth = BlockAuth.CustomAuth({
	description: `
...
4. Set a name and expiry, then copy the generated token.
	...
	props: {
		...
		personalAccessToken: BlockAuth.SecretText({
