import { AppConnectionValueForAuthProperty, OAuth2PropertyValue, OAuth2Props, BlockAuth, BlockPropValueSchema, Property, ShortTextProperty, StaticPropsValue } from '@intelblocks/blocks-framework';
import {
	httpClient,
	HttpMethod,
	AuthenticationType,
...
import { AppConnectionType, isNil, isString } from '@intelblocks/shared';
