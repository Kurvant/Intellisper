...
import { EvseCreateResponse } from '../../../models/responses';
...
export const evseCreateAction = createAction({
  ...
  async run(context): Promise<EvseCreateResponse> {
    try {
      ...
      const body = prepareRequestBody(context.propsValue,
        ['chargePointId', 'physicalReference', 'currentType', 'label', 'networkId', 'status', 'midMeterCertificationEndYear', 'tariffGroupId', 'allowsReservation', 'bookingEnabled', 'powerOptions', 'externalId']
      );
