...
import { ElectricityMetersLisingResponse } from '../../../models/responses';

/**
 * Generated from API version: 3.96.4
 */

// Endpoint: GET /public-api/resources/electricity-meters/v1.0
...
export const electricityMetersLisingAction = createAction({
  ...
  async run(context): Promise<ElectricityMetersLisingResponse> {
    try {
      ...
      return await paginate({
        ...
        dataPath: 'data',
      }) as ElectricityMetersLisingResponse;
    }
