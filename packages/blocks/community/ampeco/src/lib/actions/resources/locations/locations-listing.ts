...
import { LocationsListingResponse } from '../../../models/responses';
...
'UM': ['81', '84', '85', '67', '89', '71', '76', '95', '79']
  ...
  filter__region: Property.ShortText({
    displayName: 'Filter - Region',
    description: '',
    required: false,
  }),

  filter__city: Property.ShortText({
  ...
  async run(context): Promise<LocationsListingResponse> {
    try {
      const url = processPathParameters('/public-api/resources/locations/v2.0', context.propsValue);
