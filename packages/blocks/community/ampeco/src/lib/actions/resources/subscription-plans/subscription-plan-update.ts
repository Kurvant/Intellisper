...
import { SubscriptionPlanUpdateResponse } from '../../../models/responses';
...
export const subscriptionPlanUpdateAction = createAction({
  ...
  feePerEachPersonalChargePoint: Property.Number({
    displayName: 'Fee Per Each Personal Charge Point',
    description: 'Applies separately per each personal charge point owned by the subscriber that requires this Subscription plan.',
    required: false,
  }),
  ...
  async run(context): Promise<SubscriptionPlanUpdateResponse> {
    try {
      ...
      const body = prepareRequestBody(context.propsValue,
        ['name', 'description', 'renewalCycle', 'freeRenewalPeriods', 'type', 'baseFee', 'feePerEachPersonalChargePoint', 'postPaidChargingSessionsAccumulation', 'billingUsageThreshold', 'billingType', 'status', 'allowance', 'visibilityRestrictions']
      );
      ...
      return await makeAmpecoApiCall(
        ...
        body,
        queryParams
      ) as SubscriptionPlanUpdateResponse;
