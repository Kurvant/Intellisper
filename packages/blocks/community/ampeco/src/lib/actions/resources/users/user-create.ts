...
import { UserCreateResponse } from '../../../models/responses';
...
'AU': ['NSW', 'VIC', 'QLD', 'WA', 'SA', 'TAS', 'ACT', 'NT', 'JBT', 'CX', 'NF', 'CC', 'AQ', 'CSI', 'ACI', 'HM']
  ...
  personal_id: Property.ShortText({
  ...
  async run(context): Promise<UserCreateResponse> {
    try {
      ...
      const body = prepareRequestBody(context.propsValue,
        ['email', 'emailVerified', 'password', 'requirePasswordReset', 'first_name', 'middle_name', 'last_name', 'phone', 'country', 'state', 'city', 'post_code', 'address', 'vehicle_no', 'personal_id', 'locale', 'userGroupIds', 'externalId', 'options', 'receiveNewsAndPromotions', 'bankDetails', 'nonce']
      );
