...
import { PartnersListingResponse } from '../../../models/responses';
...
export const partnersListingAction = createAction({
  ...
  filter__regNo: Property.ShortText({
    displayName: 'Filter - Reg No',
  ...
  async run(context): Promise<PartnersListingResponse> {
    try {
