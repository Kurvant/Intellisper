...
'RO': ['AB', 'AR', 'AG', 'BC', 'BH', 'BN', 'BT', 'BV', 'BR', 'B', 'BZ', 'CL', 'CS', 'CT', 'CV', 'DB', 'DJ', 'GL', 'GR', 'GJ', 'HR', 'HD', 'IL', 'IS', 'IF', 'MM', 'MH', 'MS', 'NT', 'OT', 'PH', 'SM', 'SJ', 'SB', 'SV', 'TR', 'TM', 'TL', 'VS', 'VL', 'VN']
  ...
  workingHours__stopSessionOutsideWorkingHours: Property.StaticDropdown({
    ...
    description: 'If a User has initiated a charging session during Working hours but it is already outside of the Working hours, the session will be terminated by the system.',
    required: false,
    options: {
      options: [
      { label: 'true', value: 'true' },
  ...
  async run(context): Promise<LocationUpdateResponse> {
    try {
      ...
      const body = prepareRequestBody(context.propsValue,
        ['name', 'shortDescription', 'description', 'additionalDescription', 'geoposition', 'address', 'streetAddress', 'city', 'region', 'state', 'country', 'postCode', 'workingHours', 'timezone', 'externalId', 'roamingOperatorId', 'tags']
      );
