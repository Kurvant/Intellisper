...
import { InvoiceDetailsCreateOrUpdateResponse } from '../../../models/responses';
...
export const invoiceDetailsCreateOrUpdateAction = createAction({
  ...
  requestBody_VariantType: Property.StaticDropdown({
    ...
    options: {
      options: [
      { label: 'Ampeco Invoice Manager', value: '1' },
      { label: 'Cardcom Invoice Manager', value: '2' },
      { label: 'SoftOne Invoice Manager', value: '3' },
      { label: 'Ecpay Invoice Manager', value: '4' }
      ],
    },
  }),
  ...
  requestBody: Property.DynamicProperties({
     ...
     props: async ({ requestBody_VariantType }) => {
        ...
        const variantMap = {
          '1': {
  requireInvoice: Property.StaticDropdown({
    displayName: 'Require Invoice',
    description: '',
    required: true,
    options: {
      options: [
  ...
  individualName: Property.ShortText({
    displayName: 'Individual Name',
    description: '',
    required: false,
  }),

  individualPersonalId: Property.ShortText({
    displayName: 'Individual Personal Id',
    description: '',
    required: false,
  }),

  individualTaxId: Property.ShortText({
    displayName: 'Individual Tax Id',
    description: '',
    required: false,
  }),
  ...
  companyRegNo: Property.ShortText({
    displayName: 'Company Reg No',
    description: '',
    required: false,
  }),

  companyTaxId: Property.ShortText({
    displayName: 'Company Tax Id',
    description: '',
    required: false,
  }),

  companyTaxAdministrationOfficeName: Property.ShortText({
    displayName: 'Company Tax Administration Office Name',
    description: '',
    required: false,
  }),
...
'2': {
  invoiceRequired: Property.StaticDropdown({
    displayName: 'Invoice Required',
    description: '',
    required: true,
    options: {
      options: [
  ...
  landlinePhoneNumber: Property.ShortText({
    displayName: 'Landline Phone Number',
    description: '',
    required: false,
  }),
...
'4': {
  ...
  carrierType: Property.StaticDropdown({
    ...
    options: {
      ...
      { label: 'GreenWorld', value: 'GreenWorld' }
      ],
    },
  }),

  loveCode: Property.ShortText({
    displayName: 'Love Code',
    description: '',
    required: false,
  }),

  mobileBarCode: Property.ShortText({
    displayName: 'Mobile Bar Code',
    description: '',
    required: false,
  }),

  citizenId: Property.ShortText({
  ...
  async run(context): Promise<InvoiceDetailsCreateOrUpdateResponse> {
    try {
      ...
      return await makeAmpecoApiCall(
        ...
        body,
        queryParams
      ) as InvoiceDetailsCreateOrUpdateResponse;
