import { HttpMethod, propsValidation } from '@intelblocks/blocks-common';
import { createAction, Property, DynamicPropsValue, InputPropertyMap, PropertyContext } from '@intelblocks/blocks-framework';
