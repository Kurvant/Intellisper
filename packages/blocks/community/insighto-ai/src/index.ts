    ...
    export const insightoAuth = BlockAuth.SecretText({
      displayName: "API Key",
      description: "Your Insighto.ai API key",
      required: true,
    });
    export const insightoAi = createBlock({
      ...
      categories: [BlockCategory.ARTIFICIAL_INTELLIGENCE, BlockCategory.COMMUNICATION],
