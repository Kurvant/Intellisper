...
export const newOutput = createTrigger({
  ...
  aiMetadata: {
    description:
      'Fires when a Phantombuster agent finishes a run and posts its result to the configured webhook, representing a completed agent execution (with its exit status and result object) for the selected agent.',
  },
  props: {
