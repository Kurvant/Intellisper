...
const mistralDirectAuth = BlockAuth.SecretText({
	displayName: 'API Key',
...
const mistralCloudflareGatewayAuth = BlockAuth.CustomAuth({
	...
	props: {
		...
		gatewayAuthToken: BlockAuth.SecretText({
		...
		mistralApiKey: BlockAuth.SecretText({
