...
export const emailDelivered = createTrigger({
  auth: veroAuth,
  name: 'emailDelivered',
  ...
  aiMetadata: {
    description:
      'Fires when an email sent through Vero is successfully delivered to the recipient mail server, representing confirmed delivery for a specific user and campaign.',
  },
  props: {
