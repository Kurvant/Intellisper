import { httpClient, HttpMethod, AuthenticationType, HttpMessageBody, HttpResponse } from '@intelblocks/blocks-common';
import { BlockPropValueSchema, Property } from '@intelblocks/blocks-framework';
...
export function getAuth(context: { auth: unknown }): NinjaPipeAuth {
  const raw = context.auth as
    | (BlockPropValueSchema<typeof ninjapipeAuth> & { props?: { base_url?: string; api_key?: string } })
    | null
    | undefined;
