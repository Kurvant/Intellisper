...
## Wiring
- Add `"@activepieces/piece-ninjapipe": ["packages/blocks/community/ninjapipe/src/index.ts"]` alphabetically into the root `tsconfig.base.json` `compilerOptions.paths`.
