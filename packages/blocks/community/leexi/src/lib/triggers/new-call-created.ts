import { AppConnectionValueForAuthProperty, createTrigger, TriggerStrategy } from "@intelblocks/blocks-framework";
import { leexiAuth } from "../common/auth";
import { AuthenticationType, DedupeStrategy, httpClient, HttpMethod, Polling, pollingHelper, QueryParams } from "@intelblocks/blocks-common";
import dayjs from 'dayjs';
import { BASE_URL } from "../common/constants";
import { ListCallResponse } from "../common/types";
import { isEmpty } from "@intelblocks/shared";
