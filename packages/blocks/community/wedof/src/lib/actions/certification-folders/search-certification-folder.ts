import { HttpMethod, QueryParams, httpClient } from '@intelblocks/blocks-common';
import { wedofAuth } from '../../auth';
import { createAction, DynamicPropsValue, Property } from '@intelblocks/blocks-framework';
