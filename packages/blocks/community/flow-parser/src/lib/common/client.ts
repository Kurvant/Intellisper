import { HttpMethod, httpClient, HttpMessageBody, QueryParams } from '@intelblocks/blocks-common';
import { BlockPropValueSchema } from '@intelblocks/blocks-framework';
...
export type FlowParserApiCallParams = {
  ...
  body?: any;
  auth: BlockPropValueSchema<typeof flowParserAuth>;
};
