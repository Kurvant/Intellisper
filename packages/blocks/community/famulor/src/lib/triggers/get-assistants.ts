import { createTrigger, TriggerStrategy, BlockPropValueSchema, Property } from '@intelblocks/blocks-framework';
import { DedupeStrategy, Polling, pollingHelper } from '@intelblocks/blocks-common';
import { famulorAuth } from '../..';
import { famulorCommon } from '../common';
import dayjs from 'dayjs';

const polling: Polling<BlockPropValueSchema<any>, { type?: string; per_page?: number }> = {
