import { createAction, Property, IbFile, DynamicPropsValue } from '@intelblocks/blocks-framework';
import { HttpMethod, httpClient, HttpMessageBody, HttpHeaders } from '@intelblocks/blocks-common';
...
export const createTranscription = createAction({
    ...
    async run(context) {
        ...
        if (source_type === 'url') {
            ...
            const fileData = media['media_file'] as IbFile;
