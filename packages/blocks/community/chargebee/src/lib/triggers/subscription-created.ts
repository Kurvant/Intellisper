...
const EVENT_TYPE = 'subscription_created';
const STORE_KEY = '_chargebee_subscription_created_webhook_id';

export const subscriptionCreated = createTrigger({
  auth: chargebeeAuth,
  ...
  sampleData: {
    id: 'ev_subscriptiwwy7vs',
    occurred_at: 1776067865,
