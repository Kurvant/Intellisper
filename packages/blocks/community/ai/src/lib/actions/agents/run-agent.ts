...
export const runAgent = createAction({
  ...
  auth: BlockAuth.None(),
  props: {
    [AgentBlockProps.PROMPT]: Property.LongText({
      displayName: 'Prompt',
      description: 'Describe what you want the assistant to do.',
      required: true,
    }),
    [AgentBlockProps.AI_PROVIDER_MODEL]: Property.Object({
      displayName: 'AI Model',
      required: true,
    }),
    [AgentBlockProps.AGENT_TOOLS]: Property.Array({
      displayName: 'Agent Tools',
      required: false,
      properties: agentToolArrayItems,
    }),
    [AgentBlockProps.STRUCTURED_OUTPUT]: Property.Array({
    ...
    [AgentBlockProps.MAX_STEPS]: Property.Number({
      displayName: 'Max steps',
      description: 'The number of iterations the agent can do',
      required: true,
      defaultValue: 20,
    }),
    [AgentBlockProps.WEB_SEARCH]: Property.Checkbox({
