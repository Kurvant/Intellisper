...
export const actualBudgetAuth = BlockAuth.CustomAuth({
  ...
  props: {
    ...
    sync_id: BlockAuth.SecretText({
      displayName: 'Sync ID',
      description:
        'This is the ID from Settings → Show advanced settings → Sync ID',
      required: true,
    }),
    encryption_password: BlockAuth.SecretText({
...
export const actualbudget = createBlock({
