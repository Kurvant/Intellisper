import { HttpMethod, httpClient, HttpRequest } from '@intelblocks/blocks-common';
import { Property, TriggerStrategy } from '@intelblocks/blocks-framework';
import { TriggerHookContext } from '@intelblocks/blocks-framework';
