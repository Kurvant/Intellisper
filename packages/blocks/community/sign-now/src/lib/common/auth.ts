import { BlockAuth, OAuth2AuthorizationMethod, AppConnectionValueForAuthProperty } from '@intelblocks/blocks-framework';
import { AppConnectionType } from '@intelblocks/shared';
import { httpClient, HttpMethod } from '@intelblocks/blocks-common';

export const signNowOAuth2Auth = BlockAuth.OAuth2({
...
export const signNowApiKeyAuth = BlockAuth.CustomAuth({
  displayName: 'API Key',
