import { IbFile, createAction, Property } from '@intelblocks/blocks-framework';
import { HttpMethod, httpClient } from '@intelblocks/blocks-common';
import { spreadIfDefined } from '@intelblocks/shared';
...
export const sendEmail = createAction({
  ...
  async run(context) {
    ...
    const attachments = context.propsValue.attachments as Array<{ file: IbFile }> ?? []
