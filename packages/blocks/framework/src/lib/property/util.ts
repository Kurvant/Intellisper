import { BlockPropertyMap } from ".";
import { BlockAuthProperty } from "./authentication";
import { PropertyType } from "./input/property-type";
import { z } from "zod";
import { AUTHENTICATION_PROPERTY_NAME, isEmpty, isNil } from "@intelblocks/shared";

function buildSchema(props: BlockPropertyMap, auth: BlockAuthProperty | BlockAuthProperty[] | undefined, requireAuth: boolean | undefined = true) {
