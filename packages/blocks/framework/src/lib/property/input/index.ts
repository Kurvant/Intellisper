...
import { MarkdownVariant } from '@intelblocks/shared';
...
export type InputProperty =
  ...
  | DropdownProperty<any, boolean, BlockAuthProperty | undefined | BlockAuthProperty[]>
  | StaticDropdownProperty<any, boolean>
  | NumberProperty<boolean>
  | ArrayProperty<boolean>
  | ObjectProperty<boolean>
  | JsonProperty<boolean>
  | MultiSelectDropdownProperty<any, boolean, BlockAuthProperty | undefined | BlockAuthProperty[]>
  | StaticMultiSelectDropdownProperty<any, boolean>
  | DynamicProperties<boolean, BlockAuthProperty | BlockAuthProperty[] | undefined>
...
export const Property = {
  ...
  Dropdown<T, R extends boolean = boolean, BlockAuth extends BlockAuthProperty | BlockAuthProperty[] |  undefined = undefined>(
    request: Properties<DropdownProperty<T, R, BlockAuth>>
  ): R extends true ? DropdownProperty<T, true, BlockAuth> : DropdownProperty<T, false, BlockAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DROPDOWN,
    } as unknown as R extends true
      ? DropdownProperty<T, true, BlockAuth>
      : DropdownProperty<T, false, BlockAuth>;
  },
  ...
  MultiSelectDropdown<T, R extends boolean = boolean, BlockAuth extends BlockAuthProperty | BlockAuthProperty[] | undefined = undefined>(
    request: Properties<MultiSelectDropdownProperty<T, R, BlockAuth>>
  ): R extends true
    ? MultiSelectDropdownProperty<T, true, BlockAuth>
    : MultiSelectDropdownProperty<T, false, BlockAuth> {
    return {
      ...request,
      valueSchema: undefined,
  ...
  DynamicProperties<R extends boolean = boolean, BlockAuth extends BlockAuthProperty | BlockAuthProperty[] | undefined = undefined>(
    request: Properties<DynamicProperties<R,BlockAuth>>
  ): R extends true ? DynamicProperties<true, BlockAuth> : DynamicProperties<false, BlockAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DYNAMIC,
    } as unknown as R extends true
      ? DynamicProperties<true, BlockAuth>
      : DynamicProperties<false, BlockAuth>;
  },
