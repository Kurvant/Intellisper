...
import { AppConnectionType, isNil } from "@intelblocks/shared";

export const BlockAuthProperty = z.union([
  BasicAuthProperty,
  CustomAuthProperty,
  OAuth2Property,
  SecretTextProperty,
...
export type BlockAuthProperty = BasicAuthProperty | CustomAuthProperty<any> | OAuth2Property<any> | SecretTextProperty<boolean>;
...
export type ExtractPieceAuthPropertyTypeForMethods<T extends BlockAuthProperty | BlockAuthProperty[] | undefined> = T extends BlockAuthProperty[] ? T[number] : T extends undefined ? undefined : T;
