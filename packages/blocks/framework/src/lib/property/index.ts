...
// EXPORTED
export { IbFile } from './input/file-property';
...
export { BlockAuth,getAuthPropertyForValue } from './authentication';
...
export { BlockAuthProperty, DEFAULT_CONNECTION_DISPLAY_NAME} from './authentication';
...
export const BlockProperty = z.union([InputProperty, BlockAuthProperty])
...
export const BlockPropertyMap = z.record(z.string(), BlockProperty)
...
export { blockPropertiesUtils } from './util';

export type BlockPropValueSchema<T extends BlockProperty> =
  T extends undefined
  ? undefined
