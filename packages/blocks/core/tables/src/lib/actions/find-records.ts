...
import { AuthenticationType, httpClient, HttpMethod, propsValidation } from '@intelblocks/blocks-common';
import { FieldType, Filter, FilterOperator, ListRecordsRequest, PopulatedRecord, SeekPage } from '@intelblocks/shared';
import { z } from 'zod';
import qs from 'qs';
type FieldInfo = {
  id: string;
