import { ActionContext, ArrayProperty, CheckboxProperty, createAction, BlockAuthProperty, Property, ShortTextProperty, StaticDropdownProperty } from '@intelblocks/blocks-framework';
import { z } from 'zod';
import { propsValidation } from '@intelblocks/blocks-common';
import deepEqual from 'deep-equal';
import { common, getScopeAndKey, BlockStoreScope } from './common';

	async function executeStorageAddToList(context: ActionContext<BlockAuthProperty | undefined, {
