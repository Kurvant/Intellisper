...
import { assertNotNullOrUndefined, isEmpty, isNil } from '@intelblocks/shared';
import fs from 'fs';
...
>(
  baseUrl: BaseUrlGetter<BlockAuth>,
  auth?: AppConnectionValueForAuthProperty<
    ExtractPieceAuthPropertyTypeForMethods<BlockAuth>
  >
) => {
