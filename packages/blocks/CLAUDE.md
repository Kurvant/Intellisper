...
After creating: add path to `tsconfig.base.json`: `"@activepieces/piece-{name}": ["packages/blocks/community/{name}/src/index.ts"]`

## Structure

```
packages/blocks/community/{name}/
...
For a complete example: see `packages/blocks/community/airtable/`.
