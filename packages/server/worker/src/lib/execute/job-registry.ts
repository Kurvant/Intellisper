import { JobData, WorkerJobType } from '@intelblocks/shared'
...
import { extractBlockInfoJob } from './jobs/extract-piece-info'
...
const registry: Record<WorkerJobType, JobHandler> = {
    ...
    [WorkerJobType.EXECUTE_EXTRACT_BLOCK_INFORMATION]: extractBlockInfoJob,
