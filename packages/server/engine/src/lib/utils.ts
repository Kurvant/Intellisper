...
import { ConnectionsManager, ContextVersion, RespondHookParams, StopHookParams } from '@intelblocks/blocks-framework'
import { ExecutionError, ExecutionErrorType, formatBlockError, RespondResponse, Result, tryCatch } from '@intelblocks/shared'
...
export const utils = {
    ...
    formatExecutionError(value: ExecutionError): string {
        return JSON.stringify(formatBlockError(value, { raw: inspect(value) }))
    },
