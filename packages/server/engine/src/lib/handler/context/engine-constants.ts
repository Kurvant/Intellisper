...
export class EngineConstants {
    public static readonly BASE_CODE_DIRECTORY = process.env.IB_BASE_CODE_DIRECTORY ?? './codes'
    public static readonly INPUT_FILE = './input.json'
    public static readonly OUTPUT_FILE = './output.json'
    public static readonly DEV_BLOCKS = process.env.IB_DEV_BLOCKS?.split(',') ?? []
    public static readonly TEST_MODE = process.env.IB_TEST_MODE === 'true'
    ...
    public readonly triggerBlockName: string
    ...
    public get devBlocks(): string[] {
        return EngineConstants.DEV_BLOCKS
    }
    ...
    public constructor(params: EngineConstantsParams) {
        ...
        this.triggerBlockName = params.triggerBlockName
    ...
    public static fromExecuteFlowInput(input: ResolvedExecuteFlowOperation): EngineConstants {
        return new EngineConstants({
            ...
            triggerBlockName: input.flowVersion.trigger.settings.blockName,
    ...
    public static fromExecuteActionInput(input: ExecuteToolOperation): EngineConstants {
        return new EngineConstants({
            ...
            triggerBlockName: DEFAULT_MCP_DATA.triggerBlockName,
    ...
    public static fromExecutePropertyInput(input: Omit<ExecutePropsOptions, 'block'> & { blockName: string, blockVersion: string }): EngineConstants {
        return new EngineConstants({
            ...
            triggerBlockName: input.flowVersion?.trigger?.settings.blockName ?? DEFAULT_MCP_DATA.triggerBlockName,
