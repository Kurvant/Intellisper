import { EngineGenericError, ExecutionMode, isNil } from '@intelblocks/shared'
import { CodeSandbox } from '../../core/code/code-sandbox-common'

export const EXECUTION_MODE = process.env.IB_EXECUTION_MODE as ExecutionMode | undefined
