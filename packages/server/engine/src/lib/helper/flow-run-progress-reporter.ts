...
import { OutputContext } from '@intelblocks/blocks-framework'
import { DEFAULT_MCP_DATA, EngineGenericError, FileCompression, FileType, FlowActionType, GenericStepOutput, isFlowRunStateTerminal, isNil, logSerializer, RunEnvironment, StepOutputStatus, StepRunResponse, tryCatch, UpdateRunProgressRequest, UploadRunLogsRequest } from '@intelblocks/shared'
        ...
        return stateLock.runExclusive(async () => {
            ...
            await sendUpdateProgress({
                ...
                flowRun: {
                    ...
                    triggeredBy: engineConstants.triggerBlockName,
...
type CreateOutputContextParams = {
    ...
    flowExecutorContext: FlowExecutorContext
    stepName: string
    stepOutput: GenericStepOutput<FlowActionType.BLOCK, unknown>
}
