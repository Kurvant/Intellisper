...
import { isBase64, isNil, isString } from '@intelblocks/shared'
...
function handleBase64File(propertyValue: string): IbFile | null {
...
async function handleUrlFile(path: string): Promise<IbFile | null> {
