...
import { BranchOperator, FlowRunStatus, RouterExecutionType, tryParseFriendlyBlockError } from '@intelblocks/shared'
...
import { buildCodeAction, buildBlockAction, buildRouterWithOneCondition, buildSimpleLoopAction, generateMockEngineConstants } from './test-helper'
...
describe('piece with error handling', () => {
    ...
    it('should continue on failure when piece fails', async () => {
        ...
        const error = tryParseFriendlyBlockError(result.steps.send_http.errorMessage)
