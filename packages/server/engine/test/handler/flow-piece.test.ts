import { FlowAction, FlowRunStatus, tryParseFriendlyBlockError } from '@intelblocks/shared'
...
describe('pieceExecutor', () => {
    ...
    it('should execute fail gracefully when pieces fail', async () => {
        ...
        const failedStepError = tryParseFriendlyBlockError(verdict.failedStep.message)
