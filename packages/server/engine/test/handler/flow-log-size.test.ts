import { ExecutionType, FlowRunStatus, FlowTriggerType, FlowVersionState, GenericStepOutput, StepOutputStatus } from '@intelblocks/shared'
...
describe('flow executor log size exceeded', () => {
    ...
    describe('with small log size limit', () => {
        ...
        beforeAll(async () => {
            process.env.IB_MAX_FLOW_RUN_LOG_SIZE_MB = '0.0001'
            vi.resetModules()
