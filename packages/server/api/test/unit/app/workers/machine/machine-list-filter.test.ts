import { MachineInformation, WorkerMachineStatus, WorkerMachineType } from '@intelblocks/shared'
...
vi.mock('../../../../../src/app/enterprise/platform/platform-plan/worker-group.service', () => ({
    workerGroupService: () => ({
