import { ExecuteFlowJobData, ExecutionType, FlowTriggerType, PollingJobData, ResumeReason, RunEnvironment, StreamStepProgress, WorkerJobType } from '@intelblocks/shared'
...
describe('jobMigrations v6 → v7 (dropLogsUploadUrl)', () => {
    ...
    it('passes through non-EXECUTE_FLOW jobs at v6 without mutating shape, bumps to latest', async () => {
        ...
        expect((migrated as PollingJobData).triggerType).toBe(FlowTriggerType.BLOCK)
    })
