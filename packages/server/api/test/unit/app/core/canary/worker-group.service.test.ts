...
type WorkerGroupService = ReturnType<typeof import('../../../../../src/app/enterprise/platform/platform-plan/worker-group.service').workerGroupService>

async function loadService(): Promise<WorkerGroupService> {
    const mod = await import('../../../../../src/app/enterprise/platform/platform-plan/worker-group.service')
