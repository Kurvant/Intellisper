...
import { projectDiffService } from '../../../../../../../../src/app/enterprise/projects/project-release/project-state/project-diff.service'
import { projectStateService } from '../../../../../../../../src/app/enterprise/projects/project-release/project-state/project-state.service'
...
describe('Flow Diff Service', () => {
    ...
    it('should compare piece version only based on major and minor version', async () => {
        ...
        flowTwo.version.trigger.settings.blockVersion = '0.1.1'
        flowOne.version.trigger.settings.blockVersion = '0.1.0'
        const diff = await projectDiffService.diff({
            currentState: {
                flows: [flowOne],
            },
    ...
    it('should detect major piece version change', async () => {
        const flowOne = flowGenerator.simpleActionAndTrigger()
        const flowTwo = JSON.parse(JSON.stringify(flowOne))
        flowTwo.version.trigger.settings.blockVersion = '0.2.1'
        flowOne.version.trigger.settings.blockVersion = '0.1.0'
        const diff = await projectDiffService.diff({
            currentState: {
                flows: [flowOne],
            ...
            version: {
                ...
                trigger: {
                    ...
                    settings: {
                        ...
                        blockVersion: flowOne.version.trigger.settings.blockVersion, // blockVersion fourth
                        blockName: flowOne.version.trigger.settings.blockName, // blockName last
                    },
                },
            },
        }
