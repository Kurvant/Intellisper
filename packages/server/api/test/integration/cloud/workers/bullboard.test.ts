...
beforeAll(async () => {
    process.env.IB_QUEUE_UI_ENABLED = 'true'
    process.env.IB_QUEUE_UI_USERNAME = 'testuser'
    process.env.IB_QUEUE_UI_PASSWORD = 'testpass'
    app = await setupTestEnvironment({ fresh: true })
})

afterAll(async () => {
    delete process.env.IB_QUEUE_UI_ENABLED
    delete process.env.IB_QUEUE_UI_USERNAME
    delete process.env.IB_QUEUE_UI_PASSWORD
