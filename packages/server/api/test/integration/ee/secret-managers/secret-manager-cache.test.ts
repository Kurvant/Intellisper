import { SecretManagerProviderId, SecretManagerFieldsSeparator, SecretManagerConnectionScope } from '@intelblocks/shared'
import { safeHttp } from '@intelblocks/server-utils'
import { PlatformRole, PrincipalType } from '@intelblocks/shared'
import { FastifyBaseLogger, FastifyInstance } from 'fastify'
import { StatusCodes } from 'http-status-codes'
import { MockInstance } from 'vitest'
import { initializeDatabase } from '../../../../src/app/database'
import { databaseConnection } from '../../../../src/app/database/database-connection'
import { secretManagerCache } from '../../../../src/app/enterprise/secret-managers/secret-manager-cache'
