...
import { ibId, FieldType } from '@intelblocks/shared'
...
describe('Table API', () => {
    ...
    describeWithAuth('POST /v1/tables/:id (Update)', () => app!, (setup) => {
        ...
        it('should return 404 for non-existent table', async () => {
            ...
            const response = await ctx.post(`/v1/tables/${ibId()}`, {
                name: 'Updated Name',
                folderId: null,
            })
    ...
    describeWithAuth('GET /v1/tables/:id (Get by ID)', () => app!, (setup) => {
        ...
        it('should return 404 for non-existent ID', async () => {
            ...
            const response = await ctx.get(`/v1/tables/${ibId()}`)
