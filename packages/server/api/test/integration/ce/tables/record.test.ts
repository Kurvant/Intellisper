...
import { ibId, FieldType, FilterOperator } from '@intelblocks/shared'
...
describe('Record API', () => {
    ...
    describeWithAuth('GET /v1/records/:id (Get by ID)', () => app!, (setup) => {
        ...
        it('should return 404 for non-existent ID', async () => {
            ...
            const response = await ctx.get(`/v1/records/${ibId()}`)
    ...
    describeWithAuth('POST /v1/records/:id (Update)', () => app!, (setup) => {
        ...
        it('should return 404 for non-existent record', async () => {
            ...
            const response = await ctx.post(`/v1/records/${ibId()}`, {
                tableId: table.id,
                cells: [],
            })
