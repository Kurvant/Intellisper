import { ibId, FlowRunStatus, FlowVersionState, PauseType, RunEnvironment } from '@intelblocks/shared'
...
describe('Waitpoint service', () => {
    ...
    describe('getByFlowRunId', () => {
        it('should return null when no waitpoint exists', async () => {
            const result = await waitpointService(app.log).getByFlowRunId(ibId())
