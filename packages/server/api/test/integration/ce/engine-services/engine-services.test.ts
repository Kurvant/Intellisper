...
import { StoreScope } from '@intelblocks/blocks-framework'
...
describe('Engine Services Integration', () => {
    ...
    describe('step-files.service — createFileUploader().write()', () => {
        it('should upload a file and return a URL', async () => {
            const originalMaxFileSize = process.env.IB_MAX_FILE_SIZE_MB
            process.env.IB_MAX_FILE_SIZE_MB = '10'
            ...
            try {
                ...
                if (originalMaxFileSize === undefined) {
                    delete process.env.IB_MAX_FILE_SIZE_MB
                }
                else {
                    process.env.IB_MAX_FILE_SIZE_MB = originalMaxFileSize
                }
            }
        })
        ...
        it('should throw FileSizeError when data exceeds max size', async () => {
            const originalMaxFileSize = process.env.IB_MAX_FILE_SIZE_MB
            process.env.IB_MAX_FILE_SIZE_MB = '0.000001'
