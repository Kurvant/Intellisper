...
import { IbEnvironment, ibId, IbMultipartFile, maxSocketHttpBufferSizeBytes, spreadIfDefined } from '@intelblocks/shared'
...
export const setupServer = async (): Promise<FastifyInstance> => {
    ...
    if (system.isApp() && environment !== IbEnvironment.DEVELOPMENT) {
