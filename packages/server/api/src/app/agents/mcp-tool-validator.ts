...
import { AgentMcpTool, buildAuthHeaders, ValidateAgentMcpToolResponse } from '@intelblocks/shared'
...
const MCP_CLIENT_INFO = { name: 'intellisper-validator', version: '1.0.0' }
