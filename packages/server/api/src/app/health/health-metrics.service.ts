...
import { FlowRunStatus, InternalErrorImpactItem, PlatformId, PlatformMetricsHealthDay, PlatformMetricsHealthHistory, PlatformMetricsLive, PlatformMetricsReport, PlatformMetricsStatusPoint, RunEnvironment, StuckJob } from '@intelblocks/shared'
...
const REPORT_TTL_SECONDS = ibDayjsDuration(6, 'hours').asSeconds() // only run metrics is cached
