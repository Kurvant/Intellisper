...
export const ibReadStepCodeTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        title: 'ib_read_step_code',
        permission: Permission.READ_FLOW,
        description: 'Read the full source code, package.json, and input of a CODE step. Returns untruncated content (unlike ib_flow_structure which truncates).',
        inputSchema: {
            flowId: z.string().describe('The id of the flow'),
            stepName: z.string().describe('The name of the CODE step (e.g. "step_1"). Use ib_flow_structure to get valid values.'),
        },
