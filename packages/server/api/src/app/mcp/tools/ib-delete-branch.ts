...
export const ibDeleteBranchTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        title: 'ib_delete_branch',
        permission: Permission.WRITE_FLOW,
        description: 'Delete a branch from a router step. Cannot delete the fallback branch.',
        inputSchema: {
            flowId: z.string().describe('The id of the flow'),
            routerStepName: z.string().describe('The name of the ROUTER step. Use ib_flow_structure to get valid values.'),
