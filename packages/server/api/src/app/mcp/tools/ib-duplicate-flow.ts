...
export const ibDuplicateFlowTool = ({ mcp, userId }: McpToolContext, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        title: 'ib_duplicate_flow',
        ...
        inputSchema: {
            flowId: z.string().describe('The id of the flow to duplicate. Use ib_list_flows to find it.'),
