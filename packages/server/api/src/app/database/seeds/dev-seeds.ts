import { IbEdition, IbEnvironment, UserIdentityProvider } from '@intelblocks/shared'
...
const currentEnvIsNotDev = (): boolean => {
    ...
    return env !== IbEnvironment.DEVELOPMENT  || edition === IbEdition.ENTERPRISE
}
...
const seedDevUser = async (): Promise<void> => {
    const DEV_EMAIL = 'dev@intellisper.local'
