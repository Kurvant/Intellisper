...
import { projectStateService } from '../../enterprise/projects/project-release/project-state/project-state.service'
...
const tableBlockName = '@intelblocks/block-tables'
...
export const tableService = {
    async create({
        ...
        const table = await tableRepo().save({
            id: ibId(),
            externalId: request.externalId ?? ibId(),
            name: request.name,
            projectId,
            folderId,
        })
