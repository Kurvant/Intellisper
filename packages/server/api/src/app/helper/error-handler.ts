...
export const errorHandler = async (
    ...
    if (error instanceof IntellisperError) {
        const statusCodeMap: Partial<Record<ErrorCode, StatusCodes>> = {
            ...
            [ErrorCode.BLOCK_SYNC_NOT_SUPPORTED]: StatusCodes.BAD_REQUEST,
            ...
            [ErrorCode.MCP_BLOCK_REQUIRES_CONNECTION]: StatusCodes.BAD_REQUEST,
            [ErrorCode.MCP_BLOCK_CONNECTION_MISMATCH]: StatusCodes.BAD_REQUEST,
