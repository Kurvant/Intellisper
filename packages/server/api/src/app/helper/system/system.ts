...
const systemPropDefaultValues: Partial<Record<SystemProp, string>> = {
    ...
    [AppSystemProp.CONFIG_PATH]: path.join(os.homedir(), '.intellisper'),
    [AppSystemProp.DB_TYPE]: DatabaseType.POSTGRES,
    [AppSystemProp.EDITION]: IbEdition.COMMUNITY,
    ...
    [AppSystemProp.LOAD_TRANSLATIONS_FOR_DEV_BLOCKS]: 'false',
...
export const system = {
    ...
    getEdition(): IbEdition {
        return this.getOrThrow<IbEdition>(AppSystemProp.EDITION)
    },
    isWorker(): boolean {
