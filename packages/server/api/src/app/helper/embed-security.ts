import { IbEdition, isNil } from '@intelblocks/shared'
import { FastifyBaseLogger } from 'fastify'
import { lru, LRU } from 'tiny-lru'
import { embedSubdomainService } from '../enterprise/embed-subdomain/embed-subdomain.service'
...
async function resolveAllowedOrigins({ hostname, log }: { hostname: string, log: FastifyBaseLogger }): Promise<string[]> {
    ...
    const cacheKey = edition === IbEdition.CLOUD ? hostname : SELF_HOSTED_CACHE_KEY
