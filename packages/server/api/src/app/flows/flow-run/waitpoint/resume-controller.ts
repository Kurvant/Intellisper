...
export const resumeController: FastifyPluginAsyncZod = async (app) => {
     ...
     * Handles resume for V0 waitpoints created by legacy blocks using run.pause() + generateResumeUrl().
     * The requestId param is NOT validated — flowRunId (an unguessable ibId) provides access control.
     */
