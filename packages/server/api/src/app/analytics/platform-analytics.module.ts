...
import { platformMustHaveFeatureEnabled } from '../enterprise/authentication/ee-authorization'
import { userIdentityHelper } from '../helper/user-identity-helper'
import { blocksAnalyticsService } from './blocks-analytics.service'
...
export const platformAnalyticsModule: FastifyPluginAsyncZod = async (app) => {
    ...
    await blocksAnalyticsService(app.log).init()
