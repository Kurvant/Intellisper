...
export function isManualBlockTrigger({ blockName, triggerName }: { blockName: string, triggerName: string }) {
    return blockName === '@intelblocks/block-manual-trigger' && triggerName === 'manual_trigger'
}
