...
import type { IbId } from './id-generator'
import type { Permission } from './security'

export class IntellisperError extends Error {
    constructor(public error: IbErrorParams, message?: string) {
...
export type IbErrorParams =
    ...
    | McpBlockRequiresConnectionParams
    | McpBlockConnectionMismatchParams
    ...
    | BlockSyncNotSupportedErrorParams
...
export type BlockSyncNotSupportedErrorParams = BaseErrorParams<ErrorCode.BLOCK_SYNC_NOT_SUPPORTED, {
    release: string
    message: string
}>
...
export type McpBlockRequiresConnectionParams = BaseErrorParams<ErrorCode.MCP_BLOCK_REQUIRES_CONNECTION, {
    blockName: string
}>

export type McpBlockConnectionMismatchParams = BaseErrorParams<ErrorCode.MCP_BLOCK_CONNECTION_MISMATCH, {
    blockName: string
...
export enum ErrorCode {
    ...
    BLOCK_SYNC_NOT_SUPPORTED = 'BLOCK_SYNC_NOT_SUPPORTED',
