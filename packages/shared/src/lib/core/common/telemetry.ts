...
export enum TelemetryEventName {
    ...
    BLOCK_SELECTOR_SEARCH = 'block.selector.search',
}
...
export type TelemetryEvent =
  ...
  | BaseTelemetryEvent<TelemetryEventName.BLOCKS_SEARCH, BlocksSearch>
  ...
  | BaseTelemetryEvent<TelemetryEventName.BLOCK_SELECTOR_SEARCH, BlockSelectorSearch>