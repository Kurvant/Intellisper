export const AP_FUNCTIONS: IbFunction[] = [
    {
        name: 'combine',
        category: 'text',
...
export type IbFunctionBaseType = 'string' | 'number' | 'boolean' | 'date' | 'list'
export type IbFunctionArgType = IbFunctionBaseType | IbFunctionBaseType[]

export type IbFunctionDeprecation = {
    replacement?: string
    removeAfter: string
}

export type IbFunctionArgCompatibility = {
    defaultArgs?: unknown[]
}

export type IbFunction = {
    name: string
    ...
    minArgs: number
    maxArgs: number
    argTypes: IbFunctionArgType[]
    returnType: IbFunctionArgType
    deprecated?: IbFunctionDeprecation
    argCompatibility?: IbFunctionArgCompatibility
}
