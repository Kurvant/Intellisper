...
export const IntellisperProviderAuthConfig = BaseAIProviderAuthConfig.extend({
    apiKeyHash: z.string(),
})
export type IntellisperProviderAuthConfig = z.infer<typeof IntellisperProviderAuthConfig>
...
export const IntellisperProviderConfig = z.object({})
export type IntellisperProviderConfig = z.infer<typeof IntellisperProviderConfig>
...
const ProviderConfigUnion = z.discriminatedUnion('provider', [
    ...
    z.object({
        displayName: z.string().min(1),
        provider: z.literal(AIProviderName.INTELLISPER),
        config: IntellisperProviderConfig,
        auth: IntellisperProviderAuthConfig,
    }),
    z.object({
        displayName: z.string().min(1),
...
const PROVIDER_MAX_CONTEXT_TOKENS: Partial<Record<AIProviderName, number>> = {
    ...
    [AIProviderName.INTELLISPER]: 200_000,
...
export const INTELLISPER_CHAT_TIERS = [
...
export type IntellisperChatTier = typeof INTELLISPER_CHAT_TIERS[number]
