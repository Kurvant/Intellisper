...
import { IbMultipartFile } from '../../core/common/multipart-file'
import { FederatedAuthnProviderConfig } from '../../core/federated-authn'
import { FilteredBlockBehavior } from './platform.model'
...
export const UpdatePlatformRequestBody = z.object({
    ...
    logoIcon: IbMultipartFile.optional(),
    fullLogo: IbMultipartFile.optional(),
    favIcon: IbMultipartFile.optional(),
    filteredBlockNames: OptionalArrayFromQuery(z.string()),
    filteredBlockBehavior: z.nativeEnum(FilteredBlockBehavior).optional(),
    ...
    pinnedBlocks: OptionalArrayFromQuery(z.string()),
