...
import { BlockPackage } from '../pieces'
...
export type ExecuteExtractBlockMetadata = BlockPackage & { platformId: PlatformId }

export type ExecuteExtractBlockMetadataOperation = ExecuteExtractBlockMetadata & { timeoutInSeconds: number, platformId: PlatformId }
