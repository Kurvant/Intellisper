...
export const AgentBlockToolMetadata = z.object({
    blockName: z.string(),
    blockVersion: z.string(),
    actionName: z.string(),
    predefinedInput: PredefinedInputsStructure.optional(),
})
export type AgentBlockToolMetadata = z.infer<typeof AgentBlockToolMetadata>

export const AgentBlockTool = z.object({
    type: z.literal(AgentToolType.BLOCK),
    ...AgentToolBase,
    blockMetadata: AgentBlockToolMetadata,
})
export type AgentBlockTool = z.infer<typeof AgentBlockTool>
