...
function hasContinueOnFailureBranches(step: Step | FlowAction): step is CodeAction | BlockAction {
...
function getContinueOnFailureBranchPair(step: CodeAction | BlockAction): (FlowAction | undefined)[] {
