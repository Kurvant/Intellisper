...
const blockActionSettingsFields = {
    ...commonActionSettings,
...
export const BlockActionSettings = z.object({
    ...blockActionSettingsFields,
})

export type BlockActionSettings = z.infer<typeof BlockActionSettings>

export const BlockActionSchema = z.object({
    ...commonActionProps,
    type: z.literal(FlowActionType.BLOCK),
...
export type FlowAction =
    ...
    | (BaseActionProps & { type: FlowActionType.BLOCK, settings: BlockActionSettings, nextAction?: FlowAction, continueOnFailureBranches?: ContinueOnFailureBranches })
...
export type BlockAction = BaseActionProps & {
