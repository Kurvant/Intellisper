...
import { BlockPackage } from '../pieces/piece'
...
export function getDefaultJobPriority(job: JobData): keyof typeof JOB_PRIORITY {
    switch (job.jobType) {
        ...
        case WorkerJobType.EXECUTE_EXTRACT_BLOCK_INFORMATION:
...
export const ExecuteExtractBlockMetadataJobData = z.object({
    schemaVersion: z.number(),
    jobType: z.literal(WorkerJobType.EXECUTE_EXTRACT_BLOCK_INFORMATION),
...
export type ExecuteExtractBlockMetadataJobData = z.infer<typeof ExecuteExtractBlockMetadataJobData>
...
export const UserInteractionJobDataWithoutWatchingInformation = z.union([
    ...
    ExecuteExtractBlockMetadataJobData.omit({ schemaVersion: true, requestId: true, webserverId: true }),
])
