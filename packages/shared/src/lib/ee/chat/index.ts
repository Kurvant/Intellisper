...
export type ChatToolOutputs = {
    ...
    ap_execute_action:
    | { noAuthRequired: true, block: string }
    | { needsConnection: true, block: string, displayName: string }
    | { pickConnection: true, block: string, displayName: string, connections: ConnectionOption[] }
