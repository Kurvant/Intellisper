...
export const buildMockEvent = ({ event, platformId, projectId }: BuildMockEventParams): ApplicationEvent => {
    ...
    const flow = { id: ibId(), externalId: ibId(), created: isoNow, updated: isoNow }
    const flowVersion = {
        id: ibId(),
            ...
            const mock: ConnectionEvent = {
                ...
                data: {
                    connection: {
                        ...
                        blockName: '@intelblocks/block-sample',
                        status: 'ACTIVE',
                        type: 'CUSTOM_AUTH',
                        created: isoNow,
                        updated: isoNow,
