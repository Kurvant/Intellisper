...
AI providers are configured by the platform admin to centrally manage credentials and access, making [AI blocks](https://intellisper.com/blocks/ai) and their features available to everyone in all projects.
...
![Manage AI Providers](/img/screenshots/configure-ai-provider.png)
