...
![Enable Environments](/img/screenshots/enable-environments-1.png)

![Enable Environments](/img/screenshots/enable-environments-2.png)
## Getting Started

Navigate to the **Releases** page from your project sidebar to view all releases and create new ones.

![Project Releases Page](/img/screenshots/project-releases-page.png)
...
![Create Release from Project](/img/screenshots/create-release-from-project-1.png)

![Create Release from Project](/img/screenshots/create-release-from-project-2.png)
<Warning>
...
![Create Release from Git](/img/screenshots/create-git-release.png)
...
![Push Everything to Git Dialog](/img/screenshots/push-everything-to-git.png)
...
![Push to Git Dialog](/img/screenshots/push-flows-to-git-1.png)

![Push to Git Dialog](/img/screenshots/push-flows-to-git-2.png)
...
![Rollback Release](/img/screenshots/rollback-release.png)
...
![Release Details](/img/screenshots/release-details.png)
