...
description: "Connect HashiCorp Vault to Intellisper for enterprise-grade secret management"
---
...
Before connecting HashiCorp Vault to Intellisper, ensure you have:
...
Once the connection is saved, you can reference Vault secrets inside any block connection dialog — in global connections (Platform Admin) or directly in the flow builder.
