...
Secret Managers allow you to integrate external secret management systems with Intellisper, enabling centralized credential management and enhanced security for your global connections.
...
Once connected, you can reference secrets from your secret managers when configuring block connections:
...
![Manage Oauth2 apps](/img/screenshots/secret-manager.png)
...
- When the flow runs, Intellisper authenticates with your secret manager and retrieves the secret
- Secrets are fetched on-demand and never stored in Intellisper
...
![Clear secret manager cache](/img/screenshots/clear-secret-manager-cache.png)
...
- **Network Security**: Ensure your secret manager is accessible from your Intellisper instance
...
- Ensure network connectivity between Intellisper and your secret manager
