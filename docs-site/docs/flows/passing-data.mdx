...
Any Intellisper flow is a vertical diagram that **starts with a trigger step** followed by **any number of action steps**.
...
<video width="450"
  ...
  loop
  playsinline
  src="/img/passing-data-3steps.mp4"
></video>
...
<video 
  ...
  loop
  playsinline
  src="/img/passing-data-data-to-insert-panel.mp4"
></video>
...
<video 
  ...
  loop
  playsinline
  src="/img/passing-data-main-insert-data-example.mp4"
></video>
...
<img width="350" src="/img/passing-data-test-step-first.png" alt="Test your automation step first" />
...
Follow the instructions in the Generate Sample Data panel to know how your step should be tested. Some triggers will also let you Use Mock Data, which will generate static sample data from the block. We recommend that you test the step instead of using mock data.
...
<video 
  ...
  loop
  playsinline
  src="/img/passing-data-load-data.mp4"
></video>
...
<video 
  ...
  loop
  playsinline
  src="/img/passing-data-dynamic-value.mp4"
></video>
