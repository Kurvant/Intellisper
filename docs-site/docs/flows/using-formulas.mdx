...
<video
  ...
  loop
  playsinline
  src="/img/using-formulas-slash-trigger.mp4"
></video>
...
<img width="450" src="/img/using-formulas-anatomy.png" alt="A function badge with function name, argument slots, and semicolon separators" />
