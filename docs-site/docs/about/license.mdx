...
Intellisper' **core** is released as open source under the [MIT license](https://github.com/Kurvant/Intellisper/blob/main/LICENSE) and enterprise / cloud editions features are released under [Commercial License](https://github.com/Kurvant/Intellisper/blob/main/packages/ee/LICENSE)
...
Using the enterprise features (under the packages/ee and packages/server/api/src/app/ee folder) with a self-hosted instance requires an Intellisper license. If you are looking for these features, contact us at [sales@intellisper.com](mailto:sales@intellisper.com).
