...
export const createNewIssue = createTrigger({
    ...
    name: string, // Unique name across the block.
...
The Context object contains multiple helpful blocks of information and tools that can be useful while developing.
