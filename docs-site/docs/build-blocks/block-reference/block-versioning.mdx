...
description: "How to choose a version number when publishing a block"
---

Blocks are npm packages and follow **semantic versioning**.

<Note>
This page is for *block authors* deciding what version number to publish. For how flows adopt new block versions, see [Block syncing & versioning](/install/architecture/block-syncing).
</Note>
