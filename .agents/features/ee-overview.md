...
| **projects/project-plan/** | Per-project block filtering (NONE/ALLOWED) | — |
...
| **oauth-apps/** | Custom OAuth2 app credentials per block (override defaults) | — |
...
| **blocks/** | Platform block installation and management | `managePiecesEnabled` |
