...
- **kid (Key ID)**: The `id` of the signing key, embedded in the JWT header by the vendor so Intellisper knows which public key to use for verification.
