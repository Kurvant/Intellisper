...
## Project Plan (Block Filtering)

**Entity**: id, projectId (one-to-one), name, blocks[] (string array), piecesFilterType (NONE/ALLOWED), locked (boolean).

- `NONE`: All blocks available
- `ALLOWED`: Only blocks in `blocks[]` array visible
