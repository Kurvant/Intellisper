...
Cloud (`IB_EDITION=cloud`) and Enterprise (`IB_EDITION=ee`). The service checks `paidEditions` at runtime when dispatching alert emails. Both personal and team projects can subscribe, with different rules:
