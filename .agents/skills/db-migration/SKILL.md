---
name: db-migration
description: Creates TypeORM database migrations for the Intellisper server. Use when the user asks to add a column, create a table, add an index, or make any schema change to the database.
---

# Intellisper DB Migration

Create TypeORM database migrations for schema changes in the Intellisper server API.
