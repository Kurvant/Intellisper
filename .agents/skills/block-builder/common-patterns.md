...
Always use `httpClient` from `@intelblocks/blocks-common`:
...
For blocks with many actions sharing API logic, create `src/lib/common/index.ts`:
...
**Real examples:**
- `packages/blocks/community/github/src/lib/common/index.ts`
- `packages/blocks/community/stripe/src/lib/common/index.ts`
...
**Real example:** `packages/blocks/community/github/src/lib/common/index.ts` -- `githubPaginatedApiCall`
