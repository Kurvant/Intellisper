...
**Real example:** `packages/blocks/community/stripe/src/index.ts`
...
export const myAppAuth = BlockAuth.OAuth2({
  required: true,
...
**Real example:** `packages/blocks/community/github/src/index.ts`, `packages/blocks/community/zoho-campaigns/` (OAuth2 with extra `props`)
...
export const myAppAuth = BlockAuth.BasicAuth({
...
export const myAppAuth = BlockAuth.CustomAuth({
  displayName: 'Connection',
  required: true,
  props: {
...
**Real example:** `packages/blocks/community/wordpress/src/index.ts`, `packages/blocks/community/mattermost/src/index.ts`

---

## No Auth

For public APIs or utility blocks that don't need credentials.
...
**Real example:** `packages/blocks/core/qrcode/src/index.ts`
